    ...
    in empty_t recirculate_meta)
{
    ...
    state parse_crc {
        ...
        ck.clear();
        ck.add({parsed_hdr.crc.data0, parsed_hdr.crc.data1});
                ...
                inout psa_ingress_output_metadata_t ostd)
{
    ...
    apply {
        ...
        hdr.crc.crc32 = h32.get_hash({hdr.crc.data0, hdr.crc.data1});
        hdr.crc.crc16 = h16.get_hash({hdr.crc.data0, hdr.crc.data1});
        hdr.crc.crc_range = (bit<8>) h16_range.get_hash(16w50, {hdr.crc.data0, hdr.crc.data1}, 16w200);
    }
}
